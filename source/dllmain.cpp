...
// Fix Enhancers SpiderMan 3 patches added 
...
const std::vector<BYTE> commonHexEdit = { 0x80, 0x07, 0x00, 0x00, 0x38, 0x04 };
...
HexEdit CreateHexEditFromResolution(int resolutionIndex) {
    ...
    case 1:
        edit.modified = {  0x00, 0x05, 0x00, 0x00, 0xD0, 0x02 };  // 1280 x 720
        edit.offset = 0;
        break;
    case 2:
        edit.modified = {  0x00, 0x0A, 0x00, 0x00, 0xA0, 0x05 };  // 2560 x1440 
        edit.offset = 0;
        break;
    case 3:
        edit.modified = {  0x00, 0x0F, 0x00, 0x00, 0x70, 0x08 };  // 3840 x 2160
        edit.offset = 0;
        break;
    case 4:
        edit.modified = {  0x70, 0x0D, 0x00, 0x00,0xA0, 0x05 };  // 3440 x 1440
        edit.offset = 0;
        break;
    case 5:
        edit.modified = {  0xA0, 0x05, 0x00, 0x00, 0x84, 0x03 };  // 1440 x 900
        edit.offset = 0;
        break;
    case 6:
        edit.modified = {  0x40, 0x06, 0x00, 0x00, 0xB0, 0x04 };  // 1600 x 1200
        edit.offset = 0;
        break;
    case 7:
        edit.modified = {  0x00, 0x0F, 0x00, 0x00, 0x00, 0x04 };  // 3840 x 1024
        edit.offset = 0;
        break;
    case 8:
        edit.modified = {  0x70, 0x17, 0x00, 0x00, 0x38, 0x04 };  // 6000 x 1080
        edit.offset = 0;
        break;
    case 9:
        edit.modified = { 0x00, 0x0A, 0x00, 0x00, 0x38, 0x04 };  // 2560 x 1080
        edit.offset = 0;
        break;
    case 10:
        edit.modified = { 0x00, 0x0F, 0x00, 0x00, 0x40, 0x06 };  // 3840 x 1600
        edit.offset = 0;
        break;
    case 11:
        edit.modified = { 0x00, 0x05, 0x00, 0x00, 0x20, 0x03 };  // 1280 x 800
        edit.offset = 0;
        break;
    default:
